...
<?php while( $row = $stmt->fetch()) {  
  ...
  <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
       ...
       <a href="#" data-toggle="modal" data-target="#confirm-delete" class="btn btn-dark mb-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square-fill" viewBox="0 0 16 16">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="delete_admin.php?id=<?= $id?>" class="btn btn-danger btn-ok">Delete</a>
            </div>
        </div>
    </div>
</div>
